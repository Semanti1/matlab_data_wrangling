...
F = getframe(gca);
[X, Map] = frame2im(F);
k=load('randVector.mat');
indicesRnd=k.IND_rand;
...
for i = 101:800
    ...
    fileName = "csr"+num2str(indicesRnd(i)+4000)+"b.mat";
    ...
    if ~exist('ceasar_mat_test_random_700') 
        mkdir ceasar_mat_test_random_700
    end
    save_file = "ceasar_mat_test_random_700/test_"+pos_i+fileName;
...
for i = 101:800
    ...
    if ~exist('ceasar_mat_test_random_800') 
        mkdir ceasar_mat_test_random_800
    end
    save_file = "ceasar_mat_test_random_800/test_"+pos_i+fileName;
